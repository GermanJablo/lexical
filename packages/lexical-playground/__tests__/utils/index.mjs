...
export const IS_COLLAB_DOCNODE =
  process.env.E2E_EDITOR_MODE === 'rich-text-with-collab-docnode';
export const IS_COLLAB = IS_COLLAB_V1 || IS_COLLAB_V2 || IS_COLLAB_DOCNODE;
...
export async function initialize({
  ...
  if (isCollab) {
    ...
    appSettings.useDocNode = isCollab === 3;
...
export const test = base.extend({
  ...
  /** @type {number | false} */
  isCollab: IS_COLLAB_V1 ? 1 : IS_COLLAB_V2 ? 2 : IS_COLLAB_DOCNODE ? 3 : false,
  isMaxLength: false,
